...
describe('useGifs', () => {
  test('should return default values and methots', () => {
  ...
  test('should return no more 8 pervious terms', async () => {
    const { result } = renderHook(() => useGifs())
    ...
    await act(async () => await result.current.handleSearch('goku10'))
